...
namespace LigaPro_TallerClase.Controllers
{
    public class EstadiosController : Controller
    {
        ...
        public EstadiosController(LigaPro_TallerClaseContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdEstadio,Name,City,Capacity")] Estadio estadio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEstadio,Name,City,Capacity")] Estadio estadio)
        {
